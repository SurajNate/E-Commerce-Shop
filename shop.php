      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Welcome!<span class="px-2 rounded-end"><?php echo "  " . $_SESSION['username'] ?></span></h1>
            ...
            <p><a class="btn btn-lg btn-danger" href="./img/mainshop.php">Explore Now</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p><a class="btn btn-lg btn-success" href="about.php">Learn more</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-end">
            ...
            <p><a class="btn btn-lg btn-primary" href="contact.php">Contact</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="hero__categories">
            ...
            <ul>
              <li><a href="./img/freshfoodgallary.php">Fresh Food <span class="badge bg-success rounded-pill float-end me-3">9</span></a></li>
              <li><a href="./img/grocerygallary.php">Grocery <span class="badge bg-success rounded-pill float-end me-3">12</span></a></li>
              <li><a href="./img/fashiongallary.php">Fashion <span class="badge bg-success rounded-pill float-end me-3">26</span></a></li>
              <li><a href="./img/electronicsgallary.php">Electronics <span class="badge bg-success rounded-pill float-end me-3">7</span></a></li>
              <li><a href="./img/mobilesgallary.php">Mobiles <span class="badge bg-success rounded-pill float-end me-3">4</span></a></li>
              <li><a href="./img/beautygallary.php">Beauty & hygiene <span class="badge bg-success rounded-pill float-end me-3">2</span></a></li>
              <li><a href="./img/sportsgallary.php">Sports <span class="badge bg-success rounded-pill float-end me-3">19</span></a></li>
              <li><a href="./img/appliancesgallary.php">Appliances <span class="badge bg-success rounded-pill float-end me-3">14</span></a></li>
              <li><a href="./img/shoesgallary.php">Shoes <span class="badge bg-success rounded-pill float-end me-3">22</span></a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-9">
          <div class="hero__item" style="background: url(./img/hero/banner.jpg);">
            <div class="hero__text">
              ...
              <button class="btn btn-lg btn-success"><a href="./img/mainshop.php" class="link-light" style="text-decoration: none;">SHOP
                  NOW</a></button>
            </div>
          </div>
        </div>
