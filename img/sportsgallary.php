...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="hero__item border border-muted" style="background: url(../img/sports_banners.png)center/cover no-repeat;cursor: pointer;height:95vh">
                <div class="hero__text">
                    <span>SPORT COLLECTION</span>
                    <h2>Product <br />100% Garanteed </h2>
                    <p>Free Pickup and Delivery Available</p>
                    <button class="btn btn-lg btn-success"><a href="#shopnow" class="link-light" style="text-decoration: none;">SHOP NOW</a></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="products">
        <div class="container mt-5">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin10.php" type="button">
            ...
            <h2 class="text-center pb-4">SPORTS</h2>
            <div class="row">
                <?PHP
                ...
                $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `sports` order by id ASC ";
