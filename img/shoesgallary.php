...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="hero__item border border-muted" style="background: url(shoesbanner.jpg)center/cover no-repeat;cursor: pointer;height:95vh">
                <div class="hero__text">
                    <span class="bg-success text-light px-2">NEW ARRIVALS</span>
                    <h2 class="text-light">SHOES <br />100% ORININAL</h2>
    ...
    <section class="products">
        <div class="container mt-5">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin9.php" type="button">
            ...
            <h2 class="text-center pb-4">SHOES</h2>
            <div class="row">
                <?PHP
                ...
                $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `shoes` order by id ASC ";
