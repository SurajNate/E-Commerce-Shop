...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="hero__item border border-muted" style="background: url(../img/mobilesbanner.jpg)center/cover no-repeat;cursor: pointer;height:95vh">
                <div class="hero__text">
                    <span>MOBILES</span>
                    <h2 class="text-light">NEW BRANDS<br />& PRODUCTS</h2>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin8.php" type="button">
                            Add <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
            </div>
            <h2 class="text-center pb-4">MOBILES</h2>
            <div class="row">
                <?PHP
                ...
                $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `mobiles` order by id ASC ";
