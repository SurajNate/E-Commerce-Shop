...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="hero__item border border-muted" style="background: url(../img/beautybanner.jpg)center/cover no-repeat;cursor: pointer;height:95vh">
                <div class="hero__text">
                    <span class="text-light bg-success px-2">BEAUTY & HYGIENE</span>
                    <h2 class="text-light">ORIGINAL <br />BRANDS</h2>
                    <p class="text-light">Free Pickup and <br> Delivery Available</p>
    ...
    <section class="products">
        <div class="container mt-5">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin3.php" type="button">
                            Add <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
            </div>
            <h2 class="text-center pb-4">BEAUTY & HYGIENE</h2>
            ...
            <div class="row">
                ...
                $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `beauty` order by id ASC ";
