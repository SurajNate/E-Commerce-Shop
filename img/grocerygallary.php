...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="heroitem border border-muted" style="background: url(../img/grocerybanner.jpg)center/cover no-repeat;cursor: pointer;height:95vh">
                <button class="btn btn-lg btn-success text-center"><a href="#shopnow" class="link-light" style="text-decoration: none;">SHOP
                        NOW</a></button>
            </div>
        </div>
    </div>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin7.php" type="button">
                            Add <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
            </div>
            <h2 class="text-center pb-4">GROCERY</h2>
            <div class="row">
                <?PHP
                ...
                $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `grocery` order by id ASC ";
