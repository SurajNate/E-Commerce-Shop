...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    $sqlquery = "INSERT INTO shoes (name,img,brand,price,delprice,discount,ratings) VALUES ('$productname', '$productimg', '$productbrand', '$productprice', '$productdelprice', '$productdiscount', '$productratings')";


    if (mysqli_query($conn, $sqlquery)) {

      echo "<script>alert('New Product Inserted Successfully.')</script>";
      echo "<script>window.open('shoesgallary.php','_self')</script>";
    } else {
