                    ...
                    <div class="row mt-3 mx-0">
                        <div class="col-12 pb-1">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin.php" type="button">
                        ...
                        $query = " SELECT `name`, `img`, `brand` , `price`, `delprice` ,`discount`, `ratings` FROM `all_products` order by name ";
                        ...
                        ?>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 mx-0">
