...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="col-lg-12">
            <div class="hero__item border border-muted" style="background: url(../img/hero/banner.jpg)center/cover no-repeat;cursor: pointer;height:95vh">
    ...
    <section class="products">
        <div class="container mt-5">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-outline-dark" style="font-weight: 600;" href="adminlogin6.php" type="button">
            ...
            <h2 class="text-center pb-4">FRESH FOOD</h2>
            <div class="row">
                <?PHP
