        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top bg-dark py-3">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex">
                        <a class="btn btn-success mx-1" href="#"><i class="fa fa-sign-in" aria-hidden="true"></i> Log in </a>
                    </form>
                </div>
            </div>
        </nav>
        ...
        <form action="" method="POST" class="row g-3 needs-validation border border-dark p-4 rounded mt-5" novalidate>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <input type="varchar" class="form-control" id="userid" placeholder="Enter User ID" name='username' required>
            ...
            <div class="col-12">
                <button id="submit" class="btn btn-success w-100" type="submit">Log in</button>
            </div>
            <p class="text-center">don't have an account? <a class="ms-2" href="./register.php" style="text-decoration: none;">Register</a></p>
